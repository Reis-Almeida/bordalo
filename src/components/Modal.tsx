            ...
            {showModal && (
                ...
                >
                    <motion.div
                        ...
                        variants={modal}
                    >
                        <form className={Form.announceForm} onSubmit={handleForm}>
                            <div className={Form.titleContainer}>
                                <h2>Passe-nos alguns dados do imovel que deseja anunciar</h2>

                                <p className={Form.ErrorMessage}>{error}</p>
                            ...
                            <div className={Form.DropDownContainer}>
                                ...
                                <div className={Form.inputButtonContainer}>
                                    <input value={values["cep"]} onChange={handleChangeform} name="cep" id="cep"/> 
                                    <button onClick={checkAddress} sx={{ variant: "anchors.primary" }}>
                            ...
                            <div className={Form.DropDownContainer}>
                                <label className={Form.labelBlock}>Tipo de negocio:</label>

                                <div className={Form.checkContainer}>
                            ...
                            <div className={Form.DropDownContainer}>
                                <label htmlFor="message" className={Form.labelBlock}>Mensagem:</label>
                                <textarea 
                                    id="mensagem" 
                                    value={textArea} 
                            ...
                            <div className={Form.SubmitContainer}>
                                <input type="submit" value={sending ? "Enviando..." : "Enviar"} sx={{ variant: "anchors.primary" }} />
